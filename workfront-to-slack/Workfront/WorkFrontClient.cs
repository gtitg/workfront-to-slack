...
namespace workfront_to_slack.Workfront
{
    class WorkFrontClient
    {
        ...
        public List<Update> getUserUpdates(string id)
        {
            ...
            updateRequest.AddParameter("fields", "updates, updates:replies, updates:entryDate, updates:updateJournalEntry, updates:updateNote, updates:updateNote:project, updates:updateNote:task, updates:updateJournalEntry:project, updates:updateJournalEntry:task, updates:enteredByName, updates:updateJournalEntry:entryDate, updates:updateNote:entryDate, updates:combinedUpdates, updates:nestedUpdates, updates:nestedUpdates:entryDate, updates:nestedUpdates:updateJournalEntry, updates:nestedUpdates:updateNote, updates:nestedUpdates:updateNote:project, updates:nestedUpdates:updateNote:task, updates:nestedUpdates:updateJournalEntry:project, updates:nestedUpdates:updateJournalEntry:task, updates:nestedUpdates:enteredByName, updates:nestedUpdates:updateJournalEntry:entryDate, updates:nestedUpdates:updateNote:entryDate");
